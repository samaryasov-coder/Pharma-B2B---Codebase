<?php /* Smarty version Smarty-3.1.14, created on 2026-08-22 17:22:37
         compiled from "/var/www/pharmab2b/httpdocs/wa-apps/pb2b/templates/actions/company/CompanyEdit.html" */ ?>
<?php /*%%SmartyHeaderCode:2320034286a89dadd9c2086-27992876%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd6c7cedd7f07e7aa183dd287559cd449769940f8' => 
    array (
      0 => '/var/www/pharmab2b/httpdocs/wa-apps/pb2b/templates/actions/company/CompanyEdit.html',
      1 => 1787338794,
      2 => 'file',
    ),
  ...
  'unifunc' => 'content_6a89dadda003d8_67015320',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6a89dadda003d8_67015320')) {function content_6a89dadda003d8_67015320($_smarty_tpl) {?><?php if (!empty($_smarty_tpl->tpl_vars['object']->value['id'])){?>      
...
<h1 class="mt0">
    ...
    <?php }else{ ?>
        ...
        Компания <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['object']->value['name'], ENT_QUOTES, 'UTF-8', true);?>


        <?php if ((($tmp = @$_smarty_tpl->tpl_vars['object']->value['status'])===null||$tmp==='' ? 0 : $tmp)){?>
            <span class="badge small user green">Активная</span>
        <?php }else{ ?>
            <span class="badge small user">Не активная</span>
        <?php }?>
...
<?php if (!empty($_smarty_tpl->tpl_vars['object']->value['id'])){?>
    <?php $_smarty_tpl->tpl_vars['default_tab'] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['includes']->value['options']['default_tab'])===null||$tmp==='' ? 'common' : $tmp), null, 0);?>
...
" <?php if ($_smarty_tpl->tpl_vars['key']->value!=$_smarty_tpl->tpl_vars['default_tab']->value){?>style="display:none"<?php }?>>
                    <?php if ($_smarty_tpl->tpl_vars['key']->value=='common'){?>
                    ...
                    <?php }elseif($_smarty_tpl->tpl_vars['key']->value=='accreditation'){?>
                        <?php echo $_smarty_tpl->getSubTemplate ("./tabs/".((string)$_smarty_tpl->tpl_vars['key']->value).".html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

                    <?php }elseif($_smarty_tpl->tpl_vars['key']->value=='tenders'){?>
                        <?php echo $_smarty_tpl->getSubTemplate ("./tabs/".((string)$_smarty_tpl->tpl_vars['key']->value).".html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<?php }else{ ?>
    <?php /*  Call merged included template "./tabs/common.html" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./tabs/common.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '2320034286a89dadd9c2086-27992876');
content_6a89dadd9e4797_43285758($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "./tabs/common.html" */?>
<?php }?><?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2026-08-22 17:22:37
