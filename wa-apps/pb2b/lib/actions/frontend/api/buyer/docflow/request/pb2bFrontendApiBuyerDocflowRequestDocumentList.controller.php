<?php
class pb2bFrontendApiBuyerDocflowRequestDocumentListController extends pb2bFrontendCabinetController {
    public function executeAction()
    {
        ...
        $this->response = pb2bDocflowRequestDocumentResource::collection($data);
    }
}