...
abstract class pb2bWaproDataTableController extends waJsonController
{
    ...
    {
        if (!empty($this->type)) {
            $class = pb2bWaproHelper::getAppId().ucfirst($this->type).'Collection';
            if (class_exists($class)) {
                ...
                if ($class instanceof pb2bWaproCollection && method_exists($class, 'getDataTable')) {
