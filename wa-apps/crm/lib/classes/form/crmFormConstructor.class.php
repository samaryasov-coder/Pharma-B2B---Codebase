...
class crmFormConstructor
{
    ...
    public static function isFieldOfDeal($field, $exclusive = true)
    {
        ...
        $is_deal_field = null;
        $field_type = null;
        self::getFieldObject($field_id, $field_type, $is_deal_field);

        return $is_deal_field && !$exclusive || $field_type === self::FIELD_TYPE_DEAL;
    }
     ...
     * @param &$is_deal_field, side-effect var, is field of deal will be returned
     * @return crmDealField|waContactPasswordField|null
     */
    public static function getFieldObject($field_id, &$form_field_type = null, &$is_deal_field = null)
    {
        ...
        $is_deal_field = isset($deal_fields[$field_id]);
