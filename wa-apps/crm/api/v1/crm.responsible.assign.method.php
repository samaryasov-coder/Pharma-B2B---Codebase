...
class crmResponsibleAssignMethod extends crmApiAbstractMethod
{
    ...
    private function contactResponsible($contact_ids, $user_id)
    {
        ...
        if ($unsuccess_contacts) {
            $message = _w(
                'The user has not been assigned to this client because of insufficient access rights.',
                'The user has not been assigned to these clients because of insufficient access rights.',
