(function ($) {
    ...
    $.widget("custom.combobox", {
        ...
        _createAutocomplete: function () {
            ...
            if (this.element.data('autocompleteOpenTerm') === 'all' && !this.element.data('readonly')) {
        ...
        _getAutocompleteOpenTermOnClick: function () {
            if (this.element.data('autocompleteOpenTerm') === 'all') {
                return '';
            }
            return this._getAutocompleteOpenTerm();
        },
        ...
        _handleComboboxPointerDown: function () {
            ...
            if (this._dropdownWasVisibleOnMousedown) {
                ...
                this.input.autocomplete("search", this._getAutocompleteOpenTermOnClick());
                setTimeout(function () {
                    self._searchOpenedOnMousedown = false;
                }, 0);
            }
